package com.osama.osama.roomexample;
...
import com.osama.osama.roomexample.adapter.ContactsAdapter;
import com.osama.osama.roomexample.db.ContactsAppDatabase;
...
public class MainActivity extends AppCompatActivity {
 ...
 // this is called if we want to check the database for the first time or to add data
